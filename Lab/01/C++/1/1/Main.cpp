...
void gen_response1(const Request& req, Response& res) {
    ...
    auto clientWeather = cli1.Get("/data/2.5/onecall?lat=44.5653&lon=34.0615&lang=ru&units=metric&exclude=current,minutely,daily,alerts&appid=33a829c8877d879f86aecd34bfc20cac");
    if (clientTime) {
