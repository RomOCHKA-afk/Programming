...
int main()
{
	...
	srand(time(NULL));
	Student a[UCHAR_MAX];
	a[0] = vvod(a[0], "Bulov K", 5, 3, 4, 5, 3);
	a[1] = vvod(a[1], "Alibaba V", 3, 3, 3, 2, 3);
	a[2] = vvod(a[2], "Milon M", 2, 4, 4, 4, 4);
	a[3] = vvod(a[3], "Butlyar A", 1, 5, 5, 5, 5);
	a[4] = vvod(a[4], "Losev D", 8, 5, 2, 3, 3);
	a[5] = vvod(a[5], "Karov G", 4, 2, 5, 3, 3);
	a[6] = vvod(a[6], "Grigoryan R", 203, 6, 4, 2, 5);
	BozoSort(a);
	std::cout << "\n";
}